...
location = 'D:\\Python Project\\ANGEL\image\\'
...
def my_window(main):
    ...
    logo = PhotoImage(file="D:\\Python Project\\ANGEL\\image\\logo.png")
    ...
    logbgopen = Image.open('D:\\Python Project\\ANGEL\\image\\login bg.png')
    # resize image
    resized = logbgopen.resize((1200, 700), Image.LANCZOS)
    logbgimg = ImageTk.PhotoImage(resized)

    # login page background
    facebgopen = Image.open('D:\\Python Project\\ANGEL\image\\face-id.png')
    # resize image
    ...
    # login page background
    logohelp = Image.open('D:\\Python Project\\ANGEL\\image\\help.png')
    # resize image
    ...
    # login page background
    logosopen = Image.open('D:\\Python Project\\ANGEL\\image\\simage.png')
    # resize image
    ...
    # login page background
    silence_png = Image.open('D:\\Python Project\\ANGEL\\image\\silence.png')
    # resize image
    resized = silence_png.resize((45, 45), Image.LANCZOS)
    silence_png = ImageTk.PhotoImage(resized)

    # login page background
    sound_png = Image.open('D:\\Python Project\\ANGEL\\image\\sound.png')
    # resize image
    ...
    startimg = PhotoImage(file='D:\\Python Project\\ANGEL\\image\\play.png')
    ...
    if os.listdir('D:\\Python Project\\ANGEL\\samples'):
        if face_match():
            print('welcome')
        else:
            signin_frame(4)
