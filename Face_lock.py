...
xmlpath = "C:\\Users\\rohit\\AppData\\Roaming\\Python\\Python313\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml"
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.putText(img, str(accuracy), (x + 5, y + h - 5),
                        font, 1, (255, 255, 0), 1)
            cv2.putText(img, "Press 'Esc' for Retrain Face Lock",
